...
namespace gl 
{
    std::string fGetEnumName(GLenum val) {
        auto it = EnumNames.find(val);
        return (it != EnumNames.end()) ? it->second : "Unknown GLenum";
    }

    const std::unordered_map<GLenum, std::string> EnumNames = {
        ...
        { 0x933D, "GL_SAMPLE_LOCATION_SUBPIXEL_BITS_ARB" },
