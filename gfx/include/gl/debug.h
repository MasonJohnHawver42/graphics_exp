...
namespace gl::debug::quads
{
    ...
    class NaiveRenderer : public IRenderer {
    public:
        NaiveRenderer(const ShaderProgramCreateInfo& shader_param, std::pmr::memory_resource* mr = std::pmr::get_default_resource());
        ~NaiveRenderer() override = default;
    ...
    private:
        ...
        // Uniform locations
        GLint u_pos, u_texCoords, u_texture;
        GLuint vao, vbo, ebo;
    };
}
